 ...
 */
public class MainMapPandemia extends MainMap {
    ...
    public static void clickButton(MouseEvent event) throws Exception {
        try {
            if (isFirstOpening) {
                ...
                fxmlLoader = new FXMLLoader(MainMapPandemia.class.getResource("/fxml/MenuPandemiaTransmission.fxml"));
                Parent root = (Parent) fxmlLoader.load();
                Stage stageT = new Stage();
                stageT.setScene(new Scene(root));
                stageT.show();

                fxmlLoader = new FXMLLoader(MainMapPandemia.class.getResource("/fxml/MenuPandemiaSymptoms.fxml"));
                ...
                fxmlLoader = new FXMLLoader(MainMapPandemia.class.getResource("/fxml/MenuPandemiaAbilities.fxml"));
                root = (Parent) fxmlLoader.load();
